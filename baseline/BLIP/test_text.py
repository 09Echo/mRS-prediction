...
def mrstest():
    ...
    weights = [path + '0fold_25epoch_73.08%acc_0.53%f1_0.959%loss.pth', path + '1fold_19epoch_69.23%acc_0.56%f1_0.849%loss.pth',
               path + '2fold_21epoch_76.00%acc_0.73%f1_0.460%loss.pth', path + '3fold_27epoch_72.00%acc_0.53%f1_0.853%loss.pth',
               path + '4fold_12epoch_72.00%acc_0.59%f1_0.599%loss.pth']
    txt_path = '/home/hubin/Codes/ISLES2024/image_text_models/results'
    txt_path = os.path.join(txt_path,'BLIP')
    with open(txt_path, 'a') as file:
        # 持续写入内容
        file.write('\n')
        file.write("比例1:2,学习率2e-4,Epochs:200,patience:50" + '\n')
