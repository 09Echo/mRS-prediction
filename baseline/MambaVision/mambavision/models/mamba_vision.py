...
if __name__ == '__main__':
    ...
    model = mamba_vision_T(prtrained=True, model_path='/home/hubin/Collateral/scodeeeee/MambaVision-T-1K',num_classes=2).cuda()
    #model = mamba_vision_T(pretrained=False).cuda()
