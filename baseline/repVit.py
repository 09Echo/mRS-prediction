...
class RepViT(nn.Module):
    def __init__(self, cfgs, num_classes=1000, distillation=False, in_chan=3):
...
@register_model
def repvit_m3(pretrained=False, num_classes=2, distillation=False):
    """
    Constructs a MobileNetV3-Large model
    """
    cfgs = [
