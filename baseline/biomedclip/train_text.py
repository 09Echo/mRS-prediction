...
def get_args_parser():
    ...
    parser.add_argument('--weights',default=[1,1],help='cross entropyloss') #1.65
    parser.add_argument('--save_path',default='/home/hubin/Codes/ISLES2024/image_text_models/savemodels/Biomedclip')
    return parser
    ...
    for ki in [1]:
        ...
        for epoch in range(args.epochs):
            ...
            for step, data in enumerate(train_dl):
                ...
                logits = model(images, patient_text)
            ...
            with torch.no_grad():
                for step, test_data in enumerate(test_dl):
                    ...
                    outputs = model(test_images,test_patient_text)
